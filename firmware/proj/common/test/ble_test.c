...
#endif
#if (CFG_PRF_ANPC_EN || CFG_PRF_ANPS_EN)
...
#endif
#if (CFG_PRF_PASPC_EN || CFG_PRF_PASPS_EN)
...
int ble_config(int role)
{
    ...
    g_BleCfg.pairing_mode = CFG_BLE_DEV_PAIR_MODE;
    g_BleCfg.att_slv_pref_conn_param_present = 1;
    g_BleCfg.svc_change_feat_present = 1;
    g_BleCfg.sugg_max_tx_octets = CFG_BLE_DEV_SUGG_MAX_TX_OCTETS;
    g_BleCfg.sugg_max_tx_time = CFG_BLE_DEV_SUGG_MAX_TX_TIME;
    g_BleCfg.max_mtu = CFG_BLE_DEV_L2CAP_MAX_MTU;
    g_BleCfg.max_mps = CFG_BLE_DEV_L2CAP_MAX_MPS;
    g_BleCfg.max_nb_lecb = CFG_BLE_DEV_L2CAP_MAX_LECB_CONN;
    g_BleCfg.tx_pref_phy = CFG_BLE_DEV_PREF_TX_PHY;
    g_BleCfg.rx_pref_phy = CFG_BLE_DEV_PREF_RX_PHY;
